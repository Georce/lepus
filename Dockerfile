...
RUN yum install -y httpd php php-mysql gcc libffi-devel python-devel openssl-devel tar MariaDB && rpm -ivh http://yum.mariadb.org/10.0/centos6-amd64/rpms/MariaDB-10.0.16-centos6-x86_64-devel.rpm && yum clean all
