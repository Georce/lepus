...
<div class="header">  
            <h1 class="page-title"><?php echo $this->lang->line('_WebServer Site'); ?> <?php echo $this->lang->line('add'); ?></h1>
</div>
...
<form name="form" class="form-horizontal" method="post" action="<?php echo site_url('webserver/add') ?>" >
...
<div class="well">
   ...
   <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id=""  name="domain"  placeholder="" value="<?php echo set_value('domain'); ?>" >
   ...
   <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id=""  name="port" value="<?php echo set_value('port','80'); ?>" >
      <span class="help-inline"></span>
    </div>
   </div>
   <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id="request"  name="request" value="<?php echo set_value('request'); ?>" >
      <span class="help-inline"></span>
    </div>
   </div>
    <div class="control-group">
   ...
   <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id="mail_to_list"  name="mail_to_list" value="<?php echo set_value('mail_to_list'); ?>" >
      <span class="help-inline"></span>
    </div>
   </div>
