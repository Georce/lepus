...
<div class="header">  
            <h1 class="page-title"><?php echo $this->lang->line('privilege'); ?> <?php echo $this->lang->line('add'); ?></h1>
</div>
...
<form name="form" class="form-horizontal" method="post" action="<?php echo site_url('privilege/add') ?>" >
...
<div class="well">
   ...
   <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id="privilege_title"  name="privilege_title" value="<?php echo set_value('privilege_title'); ?>" >
    </div>
   </div>
   <div class="control-group">
    <label class="control-label" for="">*<?php echo $this->lang->line('action'); ?></label>
    <div class="controls">
      <input type="text" id="action"  name="action" value="<?php echo set_value('action'); ?>" >
    </div>
   </div>
   <div class="control-group">
