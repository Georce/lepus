...
<div class="header">  
            <h1 class="page-title"><?php echo $this->lang->line('_Machine Room'); ?> <?php echo $this->lang->line('add'); ?></h1>
</div>
...
<form name="form" class="form-horizontal" method="post" action="<?php echo site_url('machine_room/add') ?>" >
...
<div class="well">
   ...
   <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id=""  name="code"  placeholder="" value="<?php echo set_value('code'); ?>" >
      <span class="help-inline"></span>
    </div>
   </div>
    <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id=""  name="address" placeholder=""  value="<?php echo set_value('address'); ?>" >
      <span class="help-inline"></span>
    </div>
   </div>
   <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id=""  name="on_duty_tel" placeholder=""  value="<?php echo set_value('on_duty_tel'); ?>" >
      <span class="help-inline"></span>
    </div>
   </div>
   <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id=""  name="remark" placeholder="" class="input-xxlarge"  value="<?php echo set_value('remark'); ?>" >
      <span class="help-inline"></span>
    </div>
   </div>
