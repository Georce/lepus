...
<div class="header">  
            <h1 class="page-title"><?php echo $this->lang->line('menu'); ?> <?php echo $this->lang->line('edit'); ?></h1>
</div>
...
<form name="form" class="form-horizontal" method="post" action="<?php echo site_url('menu/edit') ?>" >
...
<?php echo $this->lang->line('choose_menu_error_msg'); ?>
</div>
...
<div class="well">
    ...
    <div class="controls">
        <select name="parent_id" id="parent_id" >
         <option value="0"  ><?php echo $this->lang->line('top_menu'); ?></option>
          ...
          <option value="<?php echo $item['menu_id']; ?>" <?php echo set_selected($item['menu_id'],$parent_id) ?> ><?php echo $item['str_repeat'].$item['menu_title']; ?></option>
          <?php endforeach;?>
          <?php } ?>
        </select>
    </div>
   ...
   <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id="menu_title"  name="menu_title"  value="<?php echo set_value('menu_title',$record['menu_title']); ?>" >
    </div>
   </div>
   <div class="control-group">
    <label class="control-label" for="">*<?php echo $this->lang->line('url'); ?></label>
    <div class="controls">
      <input type="text" id="menu_url"  name="menu_url" value="<?php echo set_value('menu_url',$record['menu_url']); ?>" >
    </div>
   </div>
   <div class="control-group">
    <label class="control-label" for=""><?php echo $this->lang->line('icon'); ?></label>
    <div class="controls">
      <input type="text" id="menu_icon"  name="menu_icon" value="<?php echo set_value('menu_icon',$record['menu_icon']); ?>" >
    </div>
   </div>
   <div class="control-group">
   ...
   <div class="control-group">
    ...
    <div class="controls">
        <select name="status" id="status" >
         <option value="1" <?php echo set_selected(1,$record['status']) ?> ><?php echo $this->lang->line('display'); ?></option>
         <option value="0" <?php echo set_selected(0,$record['status']) ?> ><?php echo $this->lang->line('hidden'); ?></option>
        </select>
    </div>
   </div>
