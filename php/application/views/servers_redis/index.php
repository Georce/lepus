...
<div class="header">  
            <h1 class="page-title"><?php echo $this->lang->line('_Redis'); ?> <?php echo $this->lang->line('list'); ?></h1>
</div>
...
<div class="btn-toolbar">
    <a class="btn btn-primary " href="<?php echo site_url('servers_redis/add') ?>"><i class="icon-plus"></i> <?php echo $this->lang->line('add'); ?></a>
    <a class="btn btn-primary " href="<?php echo site_url('servers_redis/batch_add') ?>"><i class="icon-plus"></i> <?php echo $this->lang->line('batch_add'); ?></a>
    <a class="btn btn " href="<?php echo site_url('servers_redis/trash') ?>"><i class="icon-trash"></i> <?php echo $this->lang->line('trash'); ?></a>
...
<form name="form" class="form-inline" method="get" action="" >
 ...
 <input type="text" id="tags"  name="tags" value="<?php echo $setval['tags']; ?>" placeholder="<?php echo $this->lang->line('please_input_tags'); ?>" class="input-medium" >
  ...
  <a href="<?php echo site_url('servers_redis/index') ?>" class="btn btn-warning"><i class="icon-repeat"></i> <?php echo $this->lang->line('reset'); ?></a>
 ...
 <?php foreach ($datalist  as $item):?>
    <tr style="font-size: 12px;">
        ...
        <td><a href="<?php echo site_url('servers_redis/edit/'.$item['id']) ?>"  title="<?php echo $this->lang->line('edit'); ?>" ><i class="icon-pencil"></i></a>&nbsp;
        <a href="<?php echo site_url('servers_redis/delete/'.$item['id']) ?>" class="confirm_delete" title="<?php echo $this->lang->line('add_trash'); ?>" ><i class="icon-trash"></i></a>
        </td>
	</tr>
 <?php endforeach;?>
<tr>
